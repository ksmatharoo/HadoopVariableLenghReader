...
public class BytesWrapper extends BinaryComparable
     ...
     */
    public BytesWrapper() {this(EMPTY_BYTES);}
    ...
    public void setAllocated(BytesWrapper newData){
        this.bytes = newData.bytes;
        this.size = newData.size;
    }
    public void setAllocated(byte[] bytes){
        this.bytes = bytes;
     ...
     */
    public BytesWrapper(byte[] bytes, int length) {
        this.bytes = bytes;
        this.size = length;
    }
     ...
     */
    public void set(BytesWrapper newData) {
    ...
    static {                                        // register this comparator
        WritableComparator.define(BytesWritable.class, new BytesWritable.Comparator());
    }
